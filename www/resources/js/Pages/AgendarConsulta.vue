    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <a href="/homecliente" class="text-gray-800 font-bold hover:underline ml-2">Home do Cliente</a>
            </div>
        </template>
        <div class="py-12">
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="submitForm" class="space-y-4">
                            <div class="flex items-center space-x-4">
                                <label for="psicologo" class="w-32 text-right">Psicólogo:</label>
                                <select v-model="form.psicologo_id" id="psicologo" required class="rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-1/3">
